...
public class PuzzleGenerator_Window : EditorWindow
{
    ...
    static PuzzleAnchor anchoring;      // Where the puzzle object pivot(center) should be
	...
	static Vector2 windowSize = new Vector2(450, 395);
	...
	{  
		...
		GUILayout.BeginHorizontal("box");
			...
			GUILayout.BeginVertical();
                ...
                EditorGUILayout.Space();
                anchoring = (PuzzleAnchor)EditorGUILayout.EnumPopup(new GUIContent("Anchoring", "Set where's the center of whole puzzle should be"), anchoring);
			...
			GUILayout.BeginHorizontal();
				...
				GUILayout.BeginVertical();
					...
					if (useShadows)
					{
						...
						newWindowSize.y = newWindowSize.y + 60;
					}
				GUILayout.EndVertical();
			GUILayout.EndHorizontal();
	...
	void CreatePuzzle () 
	{
		...
		try 
		{
            ...
            if (generateBackground)
                puzzle.GenerateBackground(image, true, (anchoring == PuzzleAnchor.Center));
